...
description: >
  Reference for the Open Brewery DB API (free, no-auth, ~11,700 breweries). Use when fetching,
  filtering, searching, or paginating brewery data — endpoints, by_* filters, sort syntax,
  response schema. Prefer this over memory; the filter names are easy to get wrong.
---

...
name: fnb-create-app
description: >
  Scaffolds a new Nuxt 4 app under apps/ in the fnb monorepo: package.json, nuxt.config,
  tsconfig, server boilerplate, Docker service, Caddy handle block. Use for any new-app
  bootstrap; WebSocket support optional.
---
...
a catalog entry first (`docs/specs/workspace-dependency-integrity-pattern.md`). Gate with
`pnpm dep-audit`.

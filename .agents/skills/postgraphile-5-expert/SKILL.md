...
description: >
  Expert in PostGraphile 5 — GraphQL API generation from PostgreSQL. Use for configuration,
  smart tags, behaviors, inflection, security (RLS/JWT/pgSettings), plugins, schema extension,
  V4 migration, and any schema design decision that affects the generated GraphQL API.
---
...
Reference: `docs/specs/architecture-considerations/read-these/postgraphile-service-setup.md`

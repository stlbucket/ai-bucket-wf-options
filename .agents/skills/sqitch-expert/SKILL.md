...
name: sqitch-expert
description: >
  Expert in sqitch change management for this project: adding changes, dependencies,
  deploy/revert/verify, tagging, rework, plan conflicts, project structure. Use for any sqitch
  task or database-migration question.
---
...
- Full routing table: `.agents/skills/skill-map.md`

...
description: >
  Trues up a sqitch package: fills missing revert/verify files and syncs sqitch.plan with files
  on disk. Use for "true up sqitch", "sync sqitch package", or any deploy dir with missing
  counterparts.
---

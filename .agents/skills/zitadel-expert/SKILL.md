...
name: zitadel-expert
description: >
  Expert in ZITADEL, our IdP. Use for OIDC/OAuth integration, orgs/projects/apps,
  service-account auth, management/v2 APIs, token validation, Actions, multi-tenant setups, and
  self-hosting config. Trigger even on loose naming ("our IdP") — ZITADEL's scopes, claims, and
  config keys are easy to get wrong.
---

...
> The authoritative spec is `.claude/specs/deployment/tag-auto-deploy.md` (decisions TD1–TD6)
> + `.claude/specs/deployment/README.md` D15–D17 / Phase 10 — this plan sequences it and does
...
- [x] `infra/README.md` runbook: note the auto path and that `deploy.sh` now hard-gates on
      db-migrate.
- [x] `.claude/specs/deployment/README.md` + `tag-auto-deploy.md`: tick Phase 10 boxes /

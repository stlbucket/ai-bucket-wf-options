...
// The user's workspaces, rendered as the sidebar switcher's tree laid out as tenant cards.
// Self-contained (own refresh + switch state) so it can be dropped into either the desktop
// right column or the mobile "Workspaces" tab — see home index.vue.

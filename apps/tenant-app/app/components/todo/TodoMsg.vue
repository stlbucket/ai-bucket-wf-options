...
// Topics carry their own ids now (stacking v2) — Msg renders by the real topic id, known
// once the by-subject query (re)resolves. topicCreated bridges the create → refetch gap.
const { topic, fetching, startDiscussion } = useTodoMsg(() => props.todoUrn)

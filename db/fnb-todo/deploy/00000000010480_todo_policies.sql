...
alter default privileges in schema todo_api grant all on tables to anon, authenticated, service_role;
alter default privileges in schema todo_api grant all on routines to anon, authenticated, service_role;
alter default privileges in schema todo_api grant all on sequences to anon, authenticated, service_role;
...
alter default privileges in schema todo_fn grant all on tables to anon, authenticated, service_role;
alter default privileges in schema todo_fn grant all on routines to anon, authenticated, service_role;
alter default privileges in schema todo_fn grant all on sequences to anon, authenticated, service_role;

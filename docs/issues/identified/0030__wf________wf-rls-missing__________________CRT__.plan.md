...
- Consequence for the breweries dataset (`docs/specs/tenant-app/datasets/breweries/`): the
...
`docs/specs/graphql-api-pattern.md`.
...
2. Policies per the template in `docs/specs/architecture-considerations/read-these/a3-rls-policy-reference.md`:

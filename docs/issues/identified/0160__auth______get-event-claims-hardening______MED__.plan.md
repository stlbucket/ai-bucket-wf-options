...
> Invoke: `/fnb-stack-implementor docs/issues/identified/get-event-claims-hardening.plan.md`
...
3. Update `docs/specs/graphql-api-pattern.md` (Auth Context) + `package-layers-pattern.md`

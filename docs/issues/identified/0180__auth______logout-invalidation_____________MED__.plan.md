...
> Invoke: `/fnb-stack-implementor docs/issues/identified/logout-invalidation.plan.md`
...
> `docs/specs/future-auth/session-refresh-pattern.md` delivers this issue in full — Tier 1

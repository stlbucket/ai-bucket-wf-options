...
> Read `docs/specs/future-auth/zitadel-login-pattern.md` (the as-built auth contract) first.
...
`docs/specs/future-auth/session-refresh-pattern.md` authored; all five Open Questions
...
Author `docs/specs/future-auth/session-refresh-pattern.md` (companion to

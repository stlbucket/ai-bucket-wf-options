...
> Invoke: `/fnb-stack-implementor docs/issues/identified/ws-subscriptions-anon.plan.md`
...
4. Until implemented, document "GraphQL subscriptions currently resolve as anon — do not rely on
   them for tenant data" in `docs/specs/sockets-pattern.md` and the implementor skill (R21),

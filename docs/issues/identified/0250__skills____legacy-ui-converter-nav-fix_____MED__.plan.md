...
> Invoke: `/fnb-stack-spec docs/issues/identified/skill-legacy-ui-converter-nav-fix.plan.md`
...
`.agents/skills/function-bucket-legacy-ui-converter/SKILL.md` (343 lines) is mostly current — it
...
- `grep -n 'useNavRegistry\|nav-register' .agents/skills/function-bucket-legacy-ui-converter/SKILL.md` → empty.

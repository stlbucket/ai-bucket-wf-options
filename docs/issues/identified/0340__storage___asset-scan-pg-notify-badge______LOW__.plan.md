...
> Invoke: `/fnb-stack-spec docs/issues/identified/asset-scan-pg-notify-badge.plan.md` to author
> the spec (update `docs/specs/asset-storage/` + `sockets-pattern.md` references), then

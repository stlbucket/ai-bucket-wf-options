...
`apps/tenant-app/app/pages/loc/new.vue` exists but `docs/specs/tenant-app/loc/` contains
...
`site-admin/wf-*` pages are specced in `docs/specs/n8n-parallel-engine/` — organizational
choice, not a gap).

Also noted while here: `docs/specs/tenant-app/loc/` and `docs/specs/tenant-app/tools/`

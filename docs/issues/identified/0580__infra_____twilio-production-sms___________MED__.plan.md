...
> phases below in order. Spec (source of truth): `docs/specs/twilio-production-sms/`
...
(`docs/specs/resend-production-updates/`, deployed 2026-07-26). **Zero DDL** — the
...
- [ ] `docs/specs/notifications/`: README status + `infrastructure.md` env table +

...
> The authoritative spec is `docs/specs/deployment/prod-db-rebuild.md` (decisions DR1–DR7)
> + `docs/specs/deployment/README.md` D14 / Phase 9 — this plan sequences it and does not
...
- [x] Spec sync: check off Phase 9 boxes in `docs/specs/deployment/README.md` as they land.

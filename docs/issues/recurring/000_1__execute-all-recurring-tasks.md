...
>
> ```
> /fnb-stack-spec /fnb-stack-implementor docs/issues/recurring/000_1__execute-all-recurring-tasks.md
> ```
>
...
- **Execution log per plan** — at the start of a run, create
  `docs/issues/recurring/executions/YYYY_MM_DD/` (today's date). As each plan finishes, write

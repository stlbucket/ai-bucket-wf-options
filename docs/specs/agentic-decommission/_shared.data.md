...
## Status
**Draft.** Builds directly on `docs/specs/n8n-parallel-engine/_shared.data.md` (the n8n
run-log, `n8n_worker` role, webhook auth, smart tags — all unchanged) and reverses
`docs/specs/agentic-workflow-engine/_shared.data.md` (deleted in Phase 5). This file specs

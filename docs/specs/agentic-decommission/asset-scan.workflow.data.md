...
`docs/specs/n8n-workflow-engine/asset-scan.workflow.data.md`.
...
(`docs/specs/game-server/` — the workflow is the sole authority for the state transition).
...
`AGENT_*` target. `docs/specs/asset-storage/asset-scan-workflow.data.md`'s superseded-by

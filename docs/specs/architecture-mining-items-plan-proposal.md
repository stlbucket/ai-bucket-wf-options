...
The `docs/architecture/` directory (11 files) is being retired. Before deleting it, this
audit identifies every piece of information that is NOT already captured in `docs/specs/`

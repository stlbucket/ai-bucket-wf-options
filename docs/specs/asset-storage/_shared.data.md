...
`docs/issues/addressed/0350__storage___asset-image-thumbnails__________LOW__.plan.md`.
...
`docs/issues/in-flight/0010__storage___asset-detail-page…plan.md`.
...
`jwt.*` helper impls: `docs/specs/architecture-considerations/read-these/a2-auth-sql-helpers.md`.

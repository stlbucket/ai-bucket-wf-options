...
> **SUPERSEDED** by
> `docs/specs/agentic-decommission/asset-scan.workflow.data.md` — the asset-scan pipeline runs
...
`docs/issues/addressed/0350__storage___asset-image-thumbnails__________LOW__.plan.md`; decisions locked 2026-07-06: 256px/webp,

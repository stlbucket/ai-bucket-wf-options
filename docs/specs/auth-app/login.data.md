...
`docs/specs/future-auth/zitadel-login-pattern.md` for the full OIDC contract).
...
motivating case is the deep-link landing page `/auth/go/<id>` (`docs/specs/otp-login/`): its

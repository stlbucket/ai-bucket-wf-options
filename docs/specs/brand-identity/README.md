...
> **Execution Directive:** plan + build this spec via `/fnb-stack-implementor docs/specs/brand-identity/README.md`
...
`design_handoff_fn_bucket_brand`, direction *2b "The Prompt"* — handoff docs deleted 2026-07-30,
git history retains them; the shipped asset files now live at `docker/brand-assets/`)
...
| `docs/specs/future-auth/zitadel-login-pattern.md` | append a note that seed now also applies instance branding (keep specs in sync, R21) |

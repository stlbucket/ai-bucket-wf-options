...
> **Execution Directive:** plan + build this spec via `/fnb-stack-implementor docs/specs/cross-platform-compose/README.md` —
> the implementor derives the `docs/issues/` plan file (R23) from the task list below, then executes it.

...
> **Execution Directive:** plan + build this spec via `/fnb-stack-implementor docs/specs/db-testing/README.md` —
...
2026-07-21 rollout). Phase 3 (plan `docs/issues/**/0267__testing___pgtap-phase3-coverage-gaps…`)

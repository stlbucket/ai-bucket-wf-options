...
Plans: `docs/issues/identified/0185__auth______session-token-refresh___________MED__.plan.md`
...
**Per-method lifetimes (added by `00000000010295_otp_login`, spec `docs/specs/otp-login/`):**

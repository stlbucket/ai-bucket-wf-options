...
`pnpm build` green. See `docs/issues/in-flight/0010__app_______game-server-battleship__________MED__.plan.md`
...
dispatch + UI page, zero DDL) — see the sub-spec `docs/specs/game-server/checkers/`.

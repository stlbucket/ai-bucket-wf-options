...
description: TOMBSTONE — graphile-worker and the wf module are retired. The stack's workflow engine is n8n (R22); see docs/specs/n8n-parallel-engine/ + docs/specs/agentic-decommission/.
metadata:
  type: reference
---
...
- **Spec:** `docs/specs/n8n-parallel-engine/` (standup) + `docs/specs/agentic-decommission/`

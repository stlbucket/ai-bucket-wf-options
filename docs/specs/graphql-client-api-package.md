...
> Canonical stack context: `docs/specs/graphql-api-pattern.md` (Layer 3) and
> `docs/specs/package-layers-pattern.md` (package inventory). This file details codegen only.

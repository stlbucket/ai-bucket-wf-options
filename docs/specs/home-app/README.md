...
> `/fnb-stack-implementor docs/specs/home-app/README.md` —
...
Related: `docs/specs/workspace-switcher/` (tree data + switch mechanism — consumed, not
...
- [x] README status → Implemented; boxes checked; no corrections needed (code follows spec);
      synced `docs/specs/workspace-switcher/switcher.ui.md` with the `ResidencyTree` split

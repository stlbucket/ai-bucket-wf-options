...
> (`docs/specs/agentic-decommission/`, plan 0017) once every workflow — including asset-scan —
...
Relationship to prior specs: `docs/specs/agentic-workflow-engine/` is the live engine and is
not modified (beyond the shared trigger plugin gaining engine routing). The superseded
`docs/specs/n8n-workflow-engine/` (the full-replacement road-not-taken, 2026-07-17) stays a

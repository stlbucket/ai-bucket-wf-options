...
> Coexistence spec: the agentic engine (`docs/specs/agentic-workflow-engine/`, implemented)
...
> (`docs/specs/n8n-workflow-engine/`) is the provenance for the carried-over n8n mechanics.

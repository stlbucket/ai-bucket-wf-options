...
## Status
Draft. Converts `docs/specs/asset-storage/asset-scan-workflow.data.md` (v2 diamond) from the
...
inventory in `decommission.data.md`. `docs/specs/asset-storage/asset-scan-workflow.data.md`

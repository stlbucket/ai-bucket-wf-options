...
| `docs/specs/graphql-api-app/workflow/` (5 files) | spec of the retired UI — delete; this spec dir is the successor |
...
- `docs/specs/asset-storage/asset-scan-workflow.data.md`: superseded-by pointer to
  `asset-scan.workflow.data.md`; `asset-storage/README.md` + `infrastructure.md` worker mentions
  updated.
- Skills (`.agents/skills/skill-map.md` is the registration point): `graphile-worker-expert`

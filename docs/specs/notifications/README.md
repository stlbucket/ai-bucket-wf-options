...
**Phases 1, 2, 4 IMPLEMENTED & verified 2026-07-22** (plan `0360…` → `docs/issues/addressed/`).
...
- **Phase 3 (invitation email) — NOW SPECCED ELSEWHERE (2026-07-22).** Superseded by
  `docs/specs/user-invitation/` — a full ZITADEL-driven onboarding ceremony (eager user
...
### Phase 3 — Invitation email  → MOVED to `docs/specs/user-invitation/` (2026-07-22)
- [x] Design decision resolved: the invite surface is an **n8n `invite-user` workflow** fired from a
      ...
      `send-notification` there. Build it via `/fnb-stack-implementor docs/specs/user-invitation/README.md`.

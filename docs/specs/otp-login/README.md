...
- **D12 — Sequenced behind the notifications SMS pipeline** (user chose "SMS spec first, then OTP
  login"): SMS Phase 0/1 is planned/built via `docs/specs/notifications/` first; OTP login
...
- [x] `.agents/skills/fnb-stack-implementor/SKILL.md` — pre-claims OTP functions added to the

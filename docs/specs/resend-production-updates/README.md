...
| `docs/specs/notifications/` (`infrastructure.md`, `send-notification.workflow.md`) | Mode 3 sync once implemented: the email provider is Resend-over-SMTP, provider label is env-driven. |

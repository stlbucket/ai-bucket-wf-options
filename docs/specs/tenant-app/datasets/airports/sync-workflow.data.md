...
`docs/specs/graphql-api-app/worker-pattern.md`. Dataset details:
`.agents/skills/airports-expert/SKILL.md`. Breweries precedent:
`docs/specs/tenant-app/datasets/breweries/sync-workflow.data.md`.

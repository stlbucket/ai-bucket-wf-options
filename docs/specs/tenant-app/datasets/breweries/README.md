...
plan: `docs/issues/identified/0010__loc_______breweries-dataset_______________MED__.plan.md`.
...
`.agents/skills/breweries-expert/SKILL.md`).
...
- [x] **Kickoff `/fnb-acquire-dataset`** with the user: distilled into
      `.agents/skills/fnb-acquire-dataset/SKILL.md` (designed with the user 2026-07-09);
      registered in `.agents/skills/skill-map.md` + the `/fnb` menu (R21).

...
> implementor derives the `docs/issues/` plan file (R23) from the task list below, then executes
> it.
...
- `docs/specs/STATUS.md` "Implemented Modules" table — add `poll` when built (done — table moved out of the skill 2026-07-30).
